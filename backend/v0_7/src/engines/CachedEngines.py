...
class CachedEngine(Engine):
    ...
    def score_and_detail(self, objects, round_to=3, **param_dict):
        ...
        object_scores, details = self.engine.process_objects(objects.Texts)
...
class PMI:
    ...
    def process_objects(self, texts, round_to=2):
        ...
        aggr_pmis = aggr_pmis.fillna(0.0)  # necessary because otherwise percentile_norm will lead to all NaNs
